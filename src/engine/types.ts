...
export interface GeminiConfig {
  ...
  seed?: number;
  /** Gemini 3 reasoning effort for image planning. */
  thinkingLevel?: "high";
  /** Per-image-part source processing quality. */
  inputMediaResolution?: "ultra_high";
  /** Optional caller/chain cancellation; transport timeout remains client-owned. */
